...
| 8 | Como veterinário, quero realizar anotações de plantão, para que a equipe registre a evolução do quadro. | - Somente uma atualização por plantão <br>- Uma anotação para cada animal | Should | 5 | Sprint 3 |
| 9 | Como veterinário, quero ter acesso a um quadro de internações digital, para que seja possível visualizar quais pets estão internados, o box e o estado de saúde de cada um. | - Identificação do Paciente e Tutor <br> - Controle de cuidados | Won't | 3 | Sprint 3 |
