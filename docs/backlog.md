...
| 7 | Como recepcionista, quero que os tutores recebam notificações automáticas dos agendamentos, para que possam acompanhar ou cancelar caso necessário. | - Notificações via SMS ou email <br>- Visualização das informações da consulta (horário,data)| Should | 8 | Sprint 3|
