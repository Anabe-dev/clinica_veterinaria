...
| 8 | Como veterinário, quero realizar anotações de plantão, para que para que a equipe de veterinários registrem a evolução do quadro. | - Somente uma atualização por plantão <br>- Uma anotação para cada animal | Should | 5 | Sprint 3 |
| 9 | Como [perfil], quero [ação], para que [benefício]. | - [critério 1]<br>- [critério 2] | Must/Should/Could/Won't |(Fibonacci: 1,2,3,5,8) ou T-shirt size (P/M/G) | |
