...
| 7 | Como recepcionista, quero que os tutores recebam notificações automáticas dos agendamentos, para que possam acompanhar ou cancelar caso necessário. | - Notificações via SMS ou email <br>- Visualização das informações da consulta (horário,data)| Could | 3 | Sprint 3|
| 8 | Como veterinário, quero realizar anotações de plantão, para que a equipe de veterinários registre a evolução do quadro. | - Somente uma atualização por plantão <br>- Uma anotação para cada animal | Should | 5 | Sprint 3 |
| 9 | Como veterinário, quero ter acesso a um quadro de internações digital, para ver quais pets estão internados, o box e o estado de saúde de cada um. | - [critério 1]<br>- [critério 2] | Must/Should/Could/Won't |(Fibonacci: 1,2,3,5,8) ou T-shirt size (P/M/G) | |
|10 | Como [perfil], quero [ação], para que [benefício]. | - [critério 1]<br>- [critério 2] | Must/Should/Could/Won't |(Fibonacci: 1,2,3,5,8) ou T-shirt size (P/M/G) | |
|11 | Como [perfil], quero [ação], para que [benefício]. | - [critério 1]<br>- [critério 2] | Must/Should/Could/Won't |(Fibonacci: 1,2,3,5,8) ou T-shirt size (P/M/G) | |
|12 | Como [perfil], quero [ação], para que [benefício]. | - [critério 1]<br>- [critério 2] | Must/Should/Could/Won't |(Fibonacci: 1,2,3,5,8) ou T-shirt size (P/M/G) | |
